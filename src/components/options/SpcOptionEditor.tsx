...
const defaultAggregationType = aggregationTypeOptions.find((option) => option.value === defaultSpcOptions.aggregation);
...
type Props = StandardEditorProps<SpcOptions, { options: Options }>;
