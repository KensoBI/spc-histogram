...
import { TimeseriesSettings } from './types';
import { cloneDeep, defaults } from 'lodash';
import { Characteristic } from 'data/types';
import { css } from '@emotion/css';
import { Options } from './panelcfg';
import { ConstantAnnotation } from './AnnotationPlugin';
import { defaultTimeseriesOptions } from 'types';
...
export function HistogramComponent({ characteristic, settings, fieldConfig }: Props) {
  ...
  const settingsWithDefaults = React.useMemo(() => defaults(settings, defaultTimeseriesOptions), [settings]);
  ...
  //todo this overwrites the histogram bucket options.
